...
<div id="boxborder"><span>RECEPTIONIST LOGIN</span></div>
<div id="box">
   <form:form action = "receptionistLogin" method = "post">
      <table>
      <tr>
      <td> <input type = "text" name = "username"
         ...
         <tr>
            ...
            <a class = "forgotPasswordLink" href = "ReceptionistForgotPassword.jsp" >Forgot Password?</a>
