...
<div id="boxborder"><span>DOCTOR LOGIN</span></div>
<div id="box">
   <form:form action = "doctorLogin" method = "post">
      <table>
      <tr>
      <td> <input type = "text" name = "username"
         ...
         <tr>
            ...
            <a class = "forgotPasswordLink" href = "DoctorForgotPassword.jsp" >Forgot Password?</a>
