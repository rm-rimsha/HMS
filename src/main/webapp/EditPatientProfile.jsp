...
<div id="boxborder"><span>EDIT PROFILE</span></div>
<div id="box">
   <form action = "editprofile" method = "post">
      <table>
      <tr>
      <td> <input  name = "editemail" type = "email"
                            placeholder = "Email"/></td>           
            </tr>
            <tr>
      <td> <input  name = "editNumber" type = "text"
         ...
         <tr>
            ...
            <button name = "PatientId" value = "${PatientId}">Update</button>
