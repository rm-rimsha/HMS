...
<body>
	...
	<div id="box">
		<form:form action="saveRec" method="post" modelAttribute="rec">
			<table>
				<tr>
					<td>Name</td>
					<td><form:input path="name"
							placeholder="Enter name of receptionist" /></td>
					<td><form:errors path="name" cssClass="error" /></td>
				</tr>
				<tr>
					<td>Username</td>
					<td><form:input path="username"
							placeholder="Enter username of receptionist" /></td>
					<td><form:errors path="username" cssClass="error" /></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><form:input type = "password" path="password"
							placeholder="Enter password of receptionist" /></td>
				...
				<tr>
					...
					<td><form:input type = "email" path="email"
							placeholder="Enter email of receptionist" /></td>
					<td><form:errors path="email" cssClass="error" /></td>
				</tr>
				<tr>
					<td>Contact Number</td>
					<td><form:input type= "tel" path="contactNumber"
							placeholder="Enter contact number of receptionist" /></td>
					<td><form:errors path="contactNumber" cssClass="error" /></td>
				</tr>
				<tr>
					<td>Department</td>
					<td><form:input path="departmentName"
							placeholder="Enter department of receptionist" /></td>
